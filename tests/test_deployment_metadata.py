...
def test_capture_code_snapshot_falls_back_to_filesystem_when_git_is_unavailable(tmp_path, monkeypatch):
    ...
    files = {
        ...
        engine_dir / "liquidity_sweep_ob_strategy.py": 700,
        engine_dir / "m15_scalp_deep_strategy.py": 800,
        engine_dir / "m15_zone_scalp_strategy.py": 900,
        engine_dir / "swing_engine_strategy.py": 1000,
        ...
        strategy_cfg_dir / "smc_confluence.py": 1600,
        strategy_cfg_dir / "m15_scalp_deep.py": 1700,
        strategy_cfg_dir / "m15_zone_scalp.py": 1800,
        strategy_cfg_dir / "htf_short.py": 1900,
...
def test_capture_code_snapshot_marks_dirty_scope_and_uses_file_mtime(tmp_path, monkeypatch):
    ...
    for rel in [
        "strategy_manager.py",
        "smc_strategy.py",
        "liquidity_sweep_ob_strategy.py",
        "m15_scalp_deep_strategy.py",
        "m15_zone_scalp_strategy.py",
        ...
        "strategy_configs/m15_scalp_deep.py",
        "strategy_configs/m15_zone_scalp.py",
